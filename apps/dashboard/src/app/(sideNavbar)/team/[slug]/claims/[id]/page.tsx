					...
					<GridCol span={{ base: 12, md: 6, lg: 4 }}>
						{!claim.active ? (
							<Alert
								...
								h="100%"
							>
								This claim is hidden on the map. Only the owner can see this claim in their claim list.
							</Alert>
						) : claim.finished ? (
							<Alert
								variant="light"
					...
					<GridCol span={{ base: 12, md: 6, lg: 4 }}>
						{claim.externalId ? (
							<Alert
								...
								h="100%"
							>
								This claim is synced with your external source. Changes to this claim might be overridden by the
								external source.
							</Alert>
						) : (
							<Alert
								...
								h="100%"
							>
								This claim is not synced with your external source. If you have claims with external IDs, then this
								claim is not covered by them.
							</Alert>
						)}
					</GridCol>
				</Grid>
						...
						<Stack gap="md">
							<TextCard title="Country" style={{ height: '100%' }}>
								...
								{getCountryNames(claim.buildTeam.location.split(', ')).includes(
									...
									<Tooltip label="This country is in the Build Team's location list">
										<ThemeIcon color="green" size="md" variant="outline" style={{ border: 'none' }}>
											<IconCheck style={{ width: '70%', height: '70%' }} />
										</ThemeIcon>
									</Tooltip>
								) : (
									<Tooltip label="The country of this claim is not in the BuildTeam's location list. Please verify the correctness of this claim!">
