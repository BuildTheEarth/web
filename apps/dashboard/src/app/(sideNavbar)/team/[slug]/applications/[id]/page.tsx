					...
					{application.reviewer && application.reviewedAt ? (
						...
						<GridCol span={{ base: 12, sm: 12, xl: 5 }}>
							<Alert
								...
								h="100%"
							>
								This application has not been reviewed yet. Please review it to give the user feedback and potentially
								add them to {application.buildteam.name}.
							</Alert>
						</GridCol>
					)}
				</Grid>
				...
				<Box maw={{ base: '100%', sm: '85%', md: '60%', xl: '45%' }} mt="md">
					...
					{applicationAnswers.length === 0 && (
						<Alert
							...
							h="100%"
						>
							This application does not have any questions answered. The applicant either did not answer any questions
							or the application form did not have any questions at the time of application.
						</Alert>
					)}
					<Title order={2} mt="xl" mb="md">
						Review
					...
					{application.reviewedAt ? (
						...
						>
							...
							{application.reviewer?.username ? ` by ${application.reviewer?.username} ` : ''}. If you want to change
							the review decision, you can do so below. The reason provided was:
							<br />
