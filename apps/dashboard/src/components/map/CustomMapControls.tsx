...
import { IconCurrentLocation, IconHome, IconMaximize, IconMinus, IconPlus } from '@tabler/icons-react'
...
export const CustomMapControls = ({
	...
	return (
		<>
			<div className={classes.controlsContainer} data-position={position}>
				<Stack gap="xs">
