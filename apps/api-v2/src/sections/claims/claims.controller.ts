...
export class ClaimsController {
	...
	findAll(@Pagination() pagination: PaginationParams, @Filter() filter: FilterParams, @Req() req: Request) {
		const { team, slug, ...otherFilters }: { team?: string; slug?: boolean } = filter.filter;
